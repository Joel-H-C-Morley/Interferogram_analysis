...
A=0.00023; % area of atomic beam signal profile
w1=0.00017; % width of atomic beam signal profile
Ab=0.00066; % area of atomic beam background profile
w1b=0.0034; % width of atomic beam background profile


% Import experimental data
    xData=importdata('C:\Users\MOT lab\Documents\Data\yData.csv')';
    Data17a=transpose(importdata('C:\Users\MOT lab\Documents\Data\17ms-1.csv'));
    Data17=Data17a(1,:);
...
% v=[20.7,2,8]; % Input paramters for average velocity V, velocity spred dV and C3
fit = [x;finalInt(v,x)]';
fig = figure;
hold on
plot(x,finalInt(v,x))
plot(x,data,'g')
scatter(x,data,5,'*')
print(fig,'C:\Users\MOT lab\Desktop\fast','-dpng');
writematrix(fit,'C:\Users\MOT lab\Desktop\fast.csv');
hold off
toc