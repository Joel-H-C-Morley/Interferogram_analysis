...
A=0.00026; % area of atomic beam signal profile
w1=0.00018; % width of atomic beam signal profile
Ab=0.00074; % area of atomic beam background profile
w1b=0.0043; % width of atomic beam background profile


% Import experimental data
    xData=importdata('C:\Users\MOT lab\Documents\Data\yData.csv')';
    Data14a=transpose(importdata('C:\Users\MOT lab\Documents\Data\14ms-1.csv'));
    Data14=Data14a(1,:);
...
% xData=importdata('C:\Users\MOT lab\Documents\Data\yData.csv')';
% x = xData;
x=linspace(-0.005307,0.005307,916);
...
finalInt =@(v,x0) (Int(x0,v)/(max(Int(x0,v)))); % normalise the fitted signal
...
% v=[14.2000 ,   2.3938  , 13.5043]; % Input paramters for average velocity V, velocity spred dV and C3
fit=[x;finalInt(v,x)]';
fig=figure;
hold on
plot(x,finalInt(v,x))
plot(x,data,'g')
scatter(x,data,5,'*')
print(fig,'C:\Users\MOT lab\Desktop\mid','-dpng');
writematrix(fit,'C:\Users\MOT lab\Desktop\mid.csv');
